...
const About = () => {
    ...
    return (
        ...
        <FeatureContainer>
            <h2>About</h2>
            <p>The 3rd International conference on advancements in computing -2021 (ICAC2021) is organized by the
                ...
                and Information Technology domains. Primary objective of the ICAC is to uplift the research
                ...
                discuss innovative ideas, and initiate collaborative work. ICAC 2019 and ICAC 2020 were successfully conducted with a technical
